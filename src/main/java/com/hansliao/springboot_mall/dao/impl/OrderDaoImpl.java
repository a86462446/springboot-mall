...
import com.hansliao.springboot_mall.rowmapper.OrderItemRowMapper;
import com.hansliao.springboot_mall.rowmapper.OrderRowMapper;
...
public class OrderDaoImpl implements OrderDao{
    ...
    public Order getOrderById(Integer orderId){
        String sql= "SELECT user_id, order_id, total_amount, created_date, last_modified_date FROM `order` WHERE order_id= :orderId";
